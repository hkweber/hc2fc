...
class MultiGraphPlotter:
    ...
    def plot_multi_graph(self):
        ...
        datasets = {
            "anode": self.app_context.anode_browser.get_selected_datasets(),
            "cathode": self.app_context.cathode_browser.get_selected_datasets(),
            "full_cell": self.app_context.full_cell_browser.get_selected_datasets()
        }
        ...
        for dataset_type, dataset_names in datasets.items():
            for dataset_name in dataset_names:
                dataset = self.app_context.multidata_processor.get_dataset_by_name(dataset_name, dataset_type)
