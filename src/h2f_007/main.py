...
#        self._create_filtered_data_browser()
    ...
    '''
        def _create_project_section(self):
            """ Create project management buttons using ProjectManager methods. """
            ...
            tk.Button(project_frame, text="Save Project", command=self.project_manager.save_project_callback, font=UIStyling.BUTTON_FONT).pack(side="left", padx=UIStyling.PAD_X)
            tk.Button(project_frame, text="Load Project", command=self.project_manager.load_project_callback, font=UIStyling.BUTTON_FONT).pack(side="left", padx=UIStyling.PAD_X)
            tk.Button(project_frame, text="Show Loaded Plots", command=self.project_manager.show_loaded_plots, font=UIStyling.BUTTON_FONT).pack(side="left", padx=UIStyling.PAD_X)
