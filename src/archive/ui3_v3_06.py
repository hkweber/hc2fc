    ...
    def _plot_dataset(self, dataset, label, plot_type, color):
        ...
        try:
            if plot_type == "U-t (Voltage-Time)":
                ...
                fig, ax1 = plt.subplots()  # Create the main plot with two x-axes
...
class HC2FCApp:
    ...
    def _initialize_ui(self):
        ...
        self.multi_graph_plot_option = tk.StringVar(value="U-t (Voltage-Time)")  # Correct default to match plot type
