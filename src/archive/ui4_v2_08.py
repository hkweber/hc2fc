...
class HC2FCApp:
    ...
    def save_project(self, project_path):
        ...
        try:
            ...
            # Save active filters (only storing simple values)
            for dataset_type in ["anode", "cathode"]:
                ...
                project_data["filters"][dataset_type] = {
                    ...
                    "stepchange": widget.apply_step_change.get(),  # ✅ Fix: Use apply_step_change instead
                }
    ...
    def load_project(self, project_path):
        ...
        try:
            with zipfile.ZipFile(project_path, "r") as project_zip:
                    ...
                    for dataset_name in dataset_list:
                        ...
                        if dataset_csv_path in project_zip.namelist():
                            with project_zip.open(dataset_csv_path) as dataset_file:
                                ...
                                # ✅ Restore datasets to filtered_datasets
                                self.filtered_datasets[dataset_type].append(
                                    {"name": dataset_name, "data": dataset_df}
                                )

                                # ✅ Also restore to main anode/cathode datasets!
                ...
                # Step 3️⃣ - Restore datasets in the UI
                ...
                # ✅ Step 4️⃣ - Update file labels in the UI
                ...
                # ✅ Step 5️⃣ - Restore plots from ZIP
                self.loaded_plots = []
