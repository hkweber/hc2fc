...
class HC2FCApp:
    ...
    def _initialize_ui(self):
        ...
        self.modify_anode_widget = ModifyDataWidget(modify_data_frame, "Modify Anode Data", "anode", self)
        self.modify_cathode_widget = ModifyDataWidget(modify_data_frame, "Modify Cathode Data", "cathode", self)
