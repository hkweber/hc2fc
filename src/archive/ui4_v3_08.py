                ...
                for dataset_type in ["anode", "cathode"]:
                    ...
                    if dataset_csv_path in project_zip.namelist():
                        with project_zip.open(dataset_csv_path) as dataset_file:
                            ...
                            # ✅ Restore dataset in memory
                            self.datasets[dataset_type]["data"] = dataset_df
                            self.datasets[dataset_type]["file_path"].set(original_file_name)  # ✅ Update UI label

                            print(f"✅ Restored original {dataset_type} dataset: {original_file_name}")

                # ✅ Step 3: Restore UI file labels
