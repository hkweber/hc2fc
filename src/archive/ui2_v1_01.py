...
class HC2FCApp:
    ...
    def _initialize_ui(self):
        ...
        self.anode_widget = DataWidget(self.main_frame, "Anode", "anode", self)
        self.cathode_widget = DataWidget(self.main_frame, "Cathode", "cathode", self)

        # Filter Sections
        tk.Label(self.main_frame, text="Filter anode data", font=("Arial", 12, "underline")).pack(pady=5)
        self.anode_filter_widget = FilterWidget(self.main_frame, "Filter Anode Data", "anode")

        tk.Label(self.main_frame, text="Filter cathode data", font=("Arial", 12, "underline")).pack(pady=5)
        self.cathode_filter_widget = FilterWidget(self.main_frame, "Filter Cathode Data", "cathode")
