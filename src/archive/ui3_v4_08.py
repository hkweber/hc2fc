...
class ModifyDataWidget:
    ...
    def _apply_modifications(self):
        ...
        if self.compute_abs_cycle.get():
            ...
            modified_data["abs_cycle"] = abs_cycle

        # Store the modified dataset
        self.app_context.filtered_datasets[self.dataset_type].append(
            {"name": f"{self.dataset_type}_modified", "data": modified_data}
        )
        self.app_context.anode_browser.add_dataset(f"{self.dataset_type}_modified")
