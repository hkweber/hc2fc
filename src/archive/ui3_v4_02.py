...
class HC2FCApp:
    ...
    def calculate_full_cell_voltage(self):
        ...
        # Calculate full cell voltage
        full_cell_u = anode_u + cathode_u

        # Create a new dataset
        full_cell_data = pd.DataFrame({
            "Ah-Cyc-Charge-0": common_q,  # Match the charge column name
            "U[V]": full_cell_u           # Match the voltage column name
        })
        ...
        # Add the dataset to the full-cell browser
        self.full_cell_browser.add_dataset(dataset_name)
