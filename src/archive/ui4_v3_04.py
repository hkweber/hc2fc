    ...
    def load_project(self, project_path):
        ...
        try:
            with zipfile.ZipFile(project_path, "r") as project_zip:
                ...
                self.datasets["anode"]["file_path"].set("No file selected")  # Instead of replacing the variable, update it
                ...
                # ✅ Step 2: Restore datasets from the project
                    ...
                    for dataset_name in dataset_list:
                        ...
                        if dataset_csv_path in project_zip.namelist():
                            with project_zip.open(dataset_csv_path) as dataset_file:
                                ...
                                # ✅ If anode or cathode, also restore to the main dataset
                ...
                # ✅ Step 3: **Force UI update for anode/cathode file labels**
                self.root.update_idletasks()  # Forces the UI to refresh after updating StringVar

                print("✅ Datasets successfully restored in UI.")

                # ✅ Step 4: Restore filter settings from the project
                for dataset_type in ["anode", "cathode"]:
                    widget = self.anode_filter_widget if dataset_type == "anode" else self.cathode_filter_widget
