...
class HC2FCApp:
    ...
    def plot_filtered_data(self, dataset_type):
        ...
        show_cycles = widget.show_cycles.get()
        fit_type = widget.fit_option.get()
        show_key_values = widget.visualize_key_values.get()
        ...
        try:
            ...
            if show_key_values:
                key_points = self.compute_key_points(filtered_data, widget)
    ...
    def compute_key_points(self, filtered_data, dataset_type):
        """
        ...
        # Get the KeyValuesWidget for the dataset
        widget = (
