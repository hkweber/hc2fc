...
class ModifyDataWidget:
    ...
    def __init__(self, parent, label_text, dataset_type, app_context):
        ...
        self.frame.grid(row=2, column=0 if dataset_type == "anode" else 1, padx=10, pady=10, sticky="nsew")
        ...
        # Apply Button
        tk.Button(self.frame, text="Apply Modifications", command=self._apply_modifications).pack(pady=10)

    def _apply_modifications(self):
        """
        Apply selected modifications to the dataset.
        """
        self.app_context.modify_dataset(self.dataset_type)
...
class HC2FCApp:
    ...
    def __init__(self, root):
        ...
        self.modified_datasets = {"anode": [], "cathode": []}
    ...
    def _initialize_ui(self):
        ...
        modify_section = tk.Frame(self.main_frame)
        modify_section.pack(fill="x", padx=10, pady=5)

        self.anode_modify_widget = ModifyDataWidget(modify_section, "Modify Anode Data", "anode", self)
        self.cathode_modify_widget = ModifyDataWidget(modify_section, "Modify Cathode Data", "cathode", self)
    ...
    def modify_dataset(self, dataset_type):
        ...
        dataset_name = f"{dataset_type}_modified"
        self.modified_datasets[dataset_type].append({"name": dataset_name, "data": modified_data})

        messagebox.showinfo("Success", f"Modified dataset stored: {dataset_name}")
