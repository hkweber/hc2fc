...
class FilterWidget:
    ...
    def __init__(self, parent, label_text, dataset_type, app_context):
        ...
        self.plot_option.trace_add("write", lambda *args: self._on_plot_option_change()) #hkw
...
### DEBUG METHOD, REMOVE ME! hkw
    def _on_plot_option_change(self, *args):
        """ Debugging function to check if plot_option is updated dynamically """
        print(f"Plot option changed to: {self.plot_option.get()}")
