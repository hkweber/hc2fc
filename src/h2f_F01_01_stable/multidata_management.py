...
class MultiDataProcessor:
    ...
    def calculate_full_cell_voltage(self):
        ...
        anode_datasets = self.app.data_browsers["anode"].get_selected_datasets()
        cathode_datasets = self.app.data_browsers["cathode"].get_selected_datasets()
        ...
        self.app.data_browsers["full_cell"].add_dataset(dataset_name)  # Add to full cell browser
