        ...
        try:
            ...
            if "Cyc-Count" in data.columns:
                ...
                if dataset_type == "anode":
                    self.app.filter_widgets["anode"].update_cycle_options(unique_cycles)
                else:
                    self.app.filter_widgets["cathode"].update_cycle_options(unique_cycles)  
            '''
...
### plot modified and filtered data
    ...
    def plot_filtered_data(self, dataset_type):
        ...
        cycle_column = filter_widget.cycle_column_option.get()  # "Cyc-Count" or "abs_cycle"   -hkw
