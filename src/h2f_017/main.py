...
### Data import section
    ...
    def _create_data_import_section(self):
        ...
        # **Full Cell File Frame**
        fullcell_file_frame = tk.Frame(data_import_frame)
        fullcell_file_frame.pack(side="left", fill="both", expand=True, padx=UIStyling.FRAME_PADX)

        self.fullcell_widget = DataWidget(fullcell_file_frame, "Fullcell", "fullcell", self.data_manager)
        self.fullcell_widget.frame.pack(fill="both", expand=True)
